...
class Database:
    ...
    def correct_text(self, text, file="..data/wordlist.txt", max_distance=2):
        """Matndagi so‘zlarni lug‘at asosida tuzatadi, lekin juda o‘zgarganlarini o‘zgartirmaydi."""
        file = os.path.normpath(file)
        ...
        for sentence in sentences:
            ...
            for word in words:
                if word.isdigit() or word in dictionary:
                    ...
                    suggestion = find_closest_word(word, dictionary)
                    distance = levenshtein_distance(word, suggestion)
